...
def log_info(message='',file_name=''):
    ...
    create_log_handler(file_path, final_log_msg, log_size_limit=1000, back_up_count=0)
...
log_info(message='Updating log message into a file', file_name='new_file.log')